...
namespace TaxiDriverServiceWPF
{
    ...
    public partial class MainWindow : Window
    {
        ...
        /// <summary>
        /// Adds basic clients to db (for the first start)
        /// </summary>
        ...
        /// <summary>
        /// Adds basic drivers to db (for the first start)
        /// </summary>
        ...
        /// <summary>
        /// Adds basic orders to db (for the first start)
        /// </summary>
        ...
        /// <summary>
        /// Action to be performed by orders button click
        /// </summary>
        ...
        /// <summary>
        /// Action to be performed by startWork button click
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Update info about current driver
        /// </summary>
        ...
        private void endOfWork_Click(object sender, RoutedEventArgs e)
        {
            if (currentDriver == null)
            {
                MessageBox.Show("Не можна завершити зміну, не розпочавши її");
                return;
            }
            updateDriverInfo();
            Close();
